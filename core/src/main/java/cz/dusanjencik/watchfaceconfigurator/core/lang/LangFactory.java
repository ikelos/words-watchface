...
public class LangFactory {
	...
	public static AccentString[] parseDate(Calendar calendar, Resources res) {
	...
	private static SentenceBuilder parseCzech(int hour, int minute, SentenceBuilder builder) {
		...
		if(isIn(4, minute, 9)){
			...
			builder.addOrdinal(hour-1, true);
		}else
		if(isIn(10, minute, 13)){
			builder.add(R.string.to1);
			builder.addBasic(4);
			builder.add(R.string.minute);
			builder.add(R.string.quoter1, true);
			builder.add(R.string.to2);
			builder.addBasic(hour, true);
		}else
		...
		if (isIn(20, minute, 24)) {
			builder.add(R.string.to1);
			builder.addBasic(9);
			builder.add(R.string.half, true);
			builder.addOrdinal(hour, true);
		}else
		...
		if (isIn(40, minute, 43)) {
			...
			builder.addBasic(4);
			builder.add(R.string.minute);
			builder.add(R.string.quoter2, true);
			builder.add(R.string.to2);
			builder.addBasic(hour, true);
		}else
